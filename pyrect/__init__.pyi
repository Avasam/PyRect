...
MIDTOP: Final = "midtop"
MIDRIGHT: Final = "midright"
MIDLEFT: Final = "midleft"
MIDBOTTOM: Final = "midbottom"
CENTER: Final = "center"
...
class Rect(Generic[_Number]):
    ...
    def __init__(
        ...
        width: float = 0,
        height: float = 0,
        enableFloat: Literal[False] = False,
        readOnly: bool = False,
        onChange: Callable[..., object] | None = None,
        onRead: Callable[..., object] | None = None,
    ) -> None: ...
    @overload
    def __init__(
        self: Rect[float],
    ...
    def inflate(self, widthChange: float = 0, heightChange: float = 0) -> None: ...
